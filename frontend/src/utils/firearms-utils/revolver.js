...
export const revolver = {
  ...
  options_step_2: {
    revolver_bouton_barillet: {
      ...
      text_steps: {
        ...
        text_step_2: 'Tirer ou pousser le bouton de déverrouillage du barillet situé côté gauche vers l’avant',
        text_step_3: 'Basculer le barillet sur le côté',
        text_step_4: 'Pencher l’arme légèrement vers l’arrière',
        text_step_5: 'Vider les munitions éventuelles du barillet en appuyant sur la tige d’extraction située à l’avant du barillet',
        text_step_6: 'Contrôler visuellement que les chambres sont vides',
      },
    ...
    revolver_1873_us: {
      ...
      text_steps: {
        text_step_1: 'Observer l’arme en l’orientant dans une direction sans risque, en manipulant avec précaution',
        text_step_2: 'Tirer légèrement le chien/marteau vers l’arrière jusqu’à entendre un premier clic',
        text_step_3: 'Ouvrir la portière pivotante sur la droite',
        text_step_4: 'Actionner la tringle d’extraction vers l’arrière pour chaque chambre du barillet',
        text_step_5: 'Contrôler que chaque chambre est bien vide en faisant tourner le barillet',
      },
    ...
    revolver_enfield: {
      ...
      text_steps: {
        text_step_1: 'Observer l’arme en l’orientant dans une direction sans risque, en manipulant avec précaution',
        text_step_2: 'appuyer sur le levier de déverrouillage côté gauche de l’arme (pouce main droite)',
        text_step_3: 'Casser/basculer l’ensemble canon et barillet',
        text_step_4: 'Retourner l’arme et vider les munitions éventuelles du barillet',
        text_step_5: 'Contrôler visuellement que les chambres sont vides',
      },
    ...
    revolver_ancien_brisure: {
      ...
      text_steps: {
        text_step_1: 'Observer l’arme en l’orientant dans une direction sans risque, en manipulant avec précaution',
        text_step_2: 'Soulever le verrou en appuyant sur son petit bouton poussoir et casser/basculer l’ensemble canon et barille',
        text_step_3: 'Retourner l’arme afin de disposer l’arrière du barillet vers le bas et vider les munitions',
        text_step_4: 'Contrôler visuellement les chambres du barillet',
      },
    ...
    revolver_axe_barillet: {
      ...
      text_steps: {
        text_step_1: 'Observer l’arme en l’orientant dans une direction sans risque, en manipulant avec précaution',
        text_step_2: 'Tirer l’axe du barillet vers l’avant et basculer le barillet sur le côté',
        text_step_3: 'Pencher l’arme légèrement vers l’arrière',
        text_step_4: 'Appuyer sur l’axe du barillet vers l’arrière pour extraire les cartouches',
  ...
  options_step_3: {
    revolver_1873_fr: {
      ...
      text_steps: {
        text_step_1: 'Observer l’arme en l’orientant dans une direction sans risque, en manipulant avec précaution',
        text_step_2: 'Tirer le haut du levier de verrouillage de barillet vers l’arrière',
        text_step_3: 'Tirer légèrement le chien/marteau vers l’arrière jusqu’à entendre un premier clic',
        text_step_4: 'Faire tourner le barillet jusqu’à trouver une munition',
        text_step_5: 'Déverrouiller la tringle d’éjection en tournant son extrémité d’un quart de tour',
        text_step_6: 'Actionner la tringle d’extraction vers l’arrière pour chaque chambre du barillet contenant une munition',
        text_step_7: 'Contrôler que chaque chambre est bien vide en faisant tourner le barillet',
      },
      img: revolver2PortiereImg,
    ...
    revolver_verrou_1892: {
      ...
      text_steps: {
        ...
        text_step_3: 'Basculer le barillet sur le côté',
        text_step_4: 'Pencher l’arme légèrement vers l’arrière',
        text_step_5: 'Vider les munitions éventuelles du barillet en appuyant sur la tige d’extraction située à l’avant du barille',
        text_step_6: 'Contrôler visuellement que les chambres sont vides',
      },

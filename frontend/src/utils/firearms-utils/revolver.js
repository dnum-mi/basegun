...
export const revolver = {
  ...
  options: {
    ...
    revolver_bouton_barillet: {
      label: 'revolver_bouton_barillet',
      value: 'bouton-barillet',
      text: '',
      img: revolver2Img,
      video: revolver2Video,
    },
    revolver_ancien_brisure: {
      label: 'revolver_ancien_brisure',
      value: 'ancien-brisure',
      text: '',
      img: revolver2Img,
      video: revolver2Video,
    },
    revolver_verrou_1892: {
      label: 'revolver_verrou_1892',
      value: 'verrou-1892',
      img: revolver2Img,
      video: revolver2Video,
    },

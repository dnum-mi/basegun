  ...
  options: {
    ...
    fixed_magazine: {
      ...
      text_steps: {
        ...
        text_step_3: '3 - <span class="font-bold" style="color:red">[ Veiller à ne pas appuyer sur la queue de détente pendant cette manipulation ! ]</span> <br> Relever et abaisser le levier de sous garde tout en extrayant les munitions tant qu’il y a toujours des munitions présentes dans le tube magasin',

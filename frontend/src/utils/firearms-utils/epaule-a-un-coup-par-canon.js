  ...
  options: {
    cle_pouce: {
      ...
      text_steps: {
        ...
        text_step_2: 'Pousser sur la clef d’ouverture à l’aide de votre pouce, et ouvrir l’arme en la cassant tout en restant appuyé sur la clef',
        text_step_3: 'Retirer les munitions éventuelles',
        text_step_4: 'Contrôler visuellement les chambres',
      },
    ...
    cle_lefaucheux: {
      ...
      text_steps: {
        text_step_1: 'Observer l’arme en l’orientant dans une direction sans risque, en manipulant avec précaution',
        text_step_2: 'Repérer la clef présente sous les canons',
        text_step_3: 'Tourner la clef vers la droite',
        text_step_4: 'Ouvrir l’arme en la cassant',
        text_step_5: 'Retirer les munitions éventuelles',
        text_step_6: 'Contrôler visuellement les chambres',
      },
      img: epauleAUnCoupParCanonCleDarne,
    ...
    cle_darne: {
      ...
      text_steps: {
        text_step_1: 'Observer l’arme en l’orientant dans une direction sans risque, en manipulant avec précaution',
        text_step_2: 'Tirer sur les oreilles vers l’arrière',
        text_step_3: 'Tirez pour faire coulisser la culasse vers l’arrière',

...
const rows = ref([
  ['T1 2024', ''],
  ['', 'Mise en place de la rubrique d\'accessibilité sur le site basegun'],
  ['', 'Publication de la déclaration d\'accessibilité'],
  ['', 'Publication du Schéma pluriannuel de mise en accessibilité'],
  ['', 'Évaluation du niveau de conformité actuel du site et publication du score'],
  ['T2 2024', ''],
  ['', 'Auto audit de notre site avec les outils d\'analyse mis à disposition'],
  ['', 'Analyse des résultats de l\'audit'],
  ['T3 2024', ''],
  ['', 'Évaluation des correctifs à mettre en place par critère non respecté'],
  ['', 'Mise en place des correctifs'],
  ['', 'Ré Evaluation du niveau de conformité du site'],
])
</script>
...
<template>
  <div class="fr-container mt-4">
    ...
    <p>
      ...
      <strong>Schéma pluriannuel 2022-2024 de mise en accessibilité :
        <a
          target="_blank"
    ...
    <p>
      ...
      <strong>Lien vers le rapport d'audit :
        <a
          target="_blank"
    ...
    <ul>
      <li>Titre de page non pertinents</li>
      <li>Déclarations CSS de couleurs de fond d’élément et de police mal utilisées</li>
      <li>Prise de focus non visible sur l'ensemble des pages</li>
      <li>Des pièges au clavier existent sur l'ensemble des pages</li>
      <li>Absence de mécanisme permettant le contrôle par l'utilisateur des raccourcis clavier n'utilisant qu'une seule touche</li>
      <li>Absence de plan du site (application web prévue pour un usage sur mobile)</li>
      <li>Absence d'une fonctionnalité unique sur chaque page permettant d'accéder au plan du site</li>
      <li>Absence de moteur de recherche (et donc absence de cette fonctionnalité sur l'ensemble des pages)</li>
      <li>Chaque ensemble de page ne dispose que d'un système de navigation au lieu de deux</li>
      <li>Les zones de regroupement de contenus présentes dans plusieurs pages web ne peuvent être atteinte ou évitées</li>
      <li>Les contenus additionnels n'apparaissent pas au survol, ni à la prise de focus, ni à l'activation d'un composant d'interface au clavier</li>
      <li>Absence de lien d'évitement ou d'accès rapide à la zone de contenu principal</li>
    </ul>
    ...
    <ul>
      <li>
        <strong>Accueil :
          <a
            target="_blank"
            href="https://basegun.interieur.gouv.fr/accueil"
          />Lien</strong>
      </li>
      <li>
        <strong>Contact :
          <a
            target="_blank"
            href="https://basegun.interieur.gouv.fr/contact"
          />Lien</strong>
      </li>
      <li>
        <strong>Mentions légales :
          <a
            target="_blank"
            href="https://basegun.interieur.gouv.fr/mentions-legales"
          />Lien</strong>
      </li>
      <li>
        <strong>Accessibilité :
          <a
            target="_blank"
            href="https://basegun.interieur.gouv.fr/accessibilite"
          />Lien</strong>
      </li>
      <li>
        <strong>À propos :
          <a
            target="_blank"
            href="https://basegun.interieur.gouv.fr/a-propos"
          />Lien</strong>
      </li>
    </ul>
    ...
    <ul>
      <li>
        Contacter
        <strong>l'équipe du projet Basegun :
    ...
    <h2>Mise en conformité de l'application</h2>

    <DsfrTable
      title="Plan d'action de l'année en cours"
      :headers="headers"
      :rows="rows"
    />
  </div>
